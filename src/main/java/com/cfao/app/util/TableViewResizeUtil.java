 ...
 */
public class TableViewResizeUtil<T> extends TableView<T> {
    ...
    public void setVisibleRowCount(Integer nbRow){
        visibleRowCount.set(nbRow);
    }
    @Override
    ...
    public static class TableViewSkinX<T> extends TableViewSkin<T> {
        ...
        public TableViewSkinX(TableViewResizeUtil<T> tableView) {
            super(tableView);
        ...
        private int getVisibleRowCount() {
            return ((TableViewResizeUtil<T>) getSkinnable()).visibleRowCountProperty().get();
        }
    ...
    private static final Logger LOG = Logger.getLogger(TableViewResizeUtil.class
            .getName());
}