 ...
 */
public class FormationAddPlanificationController extends AnchorPane implements Initializable {
    static Logger logger = Logger.getLogger(FormationAddPlanificationController.class);
    ...
    public FormationAddPlanificationController() {
        try {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Task<ObservableMap<String, ObservableList>> task = new Task<ObservableMap<String, ObservableList>>() {
            ...
            protected ObservableMap<String, ObservableList> call() throws Exception {
                ...
                map.put("timing", FXCollections.observableArrayList(timings));
                return map;
            }
        };
        ...
        task.setOnSucceeded(new EventHandler<WorkerStateEvent>() {
            ...
            public void handle(WorkerStateEvent event) {
                ...
                comboTiming.setItems(task.getValue().get("timing"));
