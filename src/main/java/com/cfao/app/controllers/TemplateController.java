...
public class TemplateController implements Initializable, Controller {
    ...
    public Accordion Leftmenu;
     public ObservableList<Label> data = FXCollections.observableArrayList();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        leftmenuController = new LeftmenuController(Leftmenu, listPersonnes, listFormations, listCompetences,
                listProfils, listTests, listParametres, listRapports);
       ...
       StageManager.loadContent(FXMLView.TEMPLATE.getFXMLFile());
