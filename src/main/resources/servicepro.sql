...
INSERT INTO `formations` (`IDFORMATION`, `CODEFORMATION`, `MODELE`, `TITRE`, `DESCRIPTION`, `DATEDEBUT`, `DATEFIN`) VALUES
(1, 'TEST01', 2, 'Un test', 'Une description de test', '2017-05-31 23:00:00', '2017-06-16 23:00:00');
...
CREATE TABLE IF NOT EXISTS `supports` (
  `COMPETENCE` int(11) NOT NULL,
  `TUTORAT` int(11) NOT NULL,
  PRIMARY KEY (`COMPETENCE`,`TUTORAT`),
  KEY `TUTORAT` (`TUTORAT`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `tutorats`
--

CREATE TABLE IF NOT EXISTS `tutorats` (
  `IDTUTORAT` int(11) NOT NULL AUTO_INCREMENT,
  `CODE` char(8) NOT NULL,
  `LIEN` varchar(250) NOT NULL,
  PRIMARY KEY (`IDTUTORAT`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
ALTER TABLE `supports`
  ADD CONSTRAINT `supports_ibfk_1` FOREIGN KEY (`COMPETENCE`) REFERENCES `competences` (`IDCOMPETENCE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `supports_ibfk_2` FOREIGN KEY (`TUTORAT`) REFERENCES `tutorats` (`IDTUTORAT`) ON DELETE CASCADE ON UPDATE CASCADE;
